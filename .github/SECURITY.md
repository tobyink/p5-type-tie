# Type-Tie Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Type-Tie)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Type-Tie)
